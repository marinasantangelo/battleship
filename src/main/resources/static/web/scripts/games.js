...
function joinGame(evt) {
    ...
    .done(function(response){
        window.location.href = "/web/game.html?gp="+response.gpId+"&join=true"
    })
    .fail(function(){
...
function createGame(evt) {
    ...
    $.post("/api/games")
    .done(function(response){
        window.location.href = "/web/game.html?gp="+response.gpId+"&newgame=true"
    })
    .fail(function(){
...
//data in Vue.js
    ...
    methods:{
        ...
        //leaders (leaderboard)
        leaders: function(){
            let leaders = [] // va a ser un array de objetos
            let aux = [] // va a ser un array de ids
